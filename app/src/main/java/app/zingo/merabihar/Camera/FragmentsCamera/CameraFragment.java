package app.zingo.merabihar.Camera.FragmentsCamera;
...
import app.zingo.merabihar.Camera.ActivityCamera.BaseCaptureActivity;
import app.zingo.merabihar.Camera.Internal.BaseCaptureInterface;
import app.zingo.merabihar.Camera.Internal.CameraPreview;
import app.zingo.merabihar.Camera.Internal.ICallback;
import app.zingo.merabihar.Camera.UtilCamera.CameraUtil;
import app.zingo.merabihar.Camera.UtilCamera.Degrees;
import app.zingo.merabihar.Camera.UtilCamera.ImageUtil;
import app.zingo.merabihar.R;
import app.zingo.merabihar.Camera.UtilCamera.CameraIntentKey;
import app.zingo.merabihar.Util.ManufacturerUtil;

import static app.zingo.merabihar.Camera.ActivityCamera.BaseCaptureActivity.CAMERA_POSITION_BACK;
import static app.zingo.merabihar.Camera.ActivityCamera.BaseCaptureActivity.CAMERA_POSITION_FRONT;
import static app.zingo.merabihar.Camera.ActivityCamera.BaseCaptureActivity.CAMERA_POSITION_UNKNOWN;
import static app.zingo.merabihar.Camera.ActivityCamera.BaseCaptureActivity.FLASH_MODE_ALWAYS_ON;
import static app.zingo.merabihar.Camera.ActivityCamera.BaseCaptureActivity.FLASH_MODE_AUTO;
import static app.zingo.merabihar.Camera.ActivityCamera.BaseCaptureActivity.FLASH_MODE_OFF;
