...
public class ProfileFollowedAdapter extends RecyclerView.Adapter<ProfileFollowedAdapter.ViewHolder> {
    private Context context;
    private ArrayList<UserProfile> list;
    public ProfileFollowedAdapter(Context context,ArrayList<UserProfile> list) {
