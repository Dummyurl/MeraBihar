package app.zingo.merabihars.Camera.FragmentsCamera;
...
import app.zingo.merabihars.Camera.ActivityCamera.BaseCaptureActivity;
import app.zingo.merabihars.Camera.Internal.BaseCaptureInterface;
import app.zingo.merabihars.Camera.Internal.CameraPreview;
import app.zingo.merabihars.Camera.Internal.ICallback;
import app.zingo.merabihars.Camera.UtilCamera.CameraUtil;
import app.zingo.merabihars.Camera.UtilCamera.Degrees;
import app.zingo.merabihars.Camera.UtilCamera.ImageUtil;
import app.zingo.merabihars.R;
import app.zingo.merabihars.Camera.UtilCamera.CameraIntentKey;
import app.zingo.merabihars.Util.ManufacturerUtil;

import static app.zingo.merabihars.Camera.ActivityCamera.BaseCaptureActivity.CAMERA_POSITION_BACK;
import static app.zingo.merabihars.Camera.ActivityCamera.BaseCaptureActivity.CAMERA_POSITION_FRONT;
import static app.zingo.merabihars.Camera.ActivityCamera.BaseCaptureActivity.CAMERA_POSITION_UNKNOWN;
import static app.zingo.merabihars.Camera.ActivityCamera.BaseCaptureActivity.FLASH_MODE_ALWAYS_ON;
import static app.zingo.merabihars.Camera.ActivityCamera.BaseCaptureActivity.FLASH_MODE_AUTO;
import static app.zingo.merabihars.Camera.ActivityCamera.BaseCaptureActivity.FLASH_MODE_OFF;
