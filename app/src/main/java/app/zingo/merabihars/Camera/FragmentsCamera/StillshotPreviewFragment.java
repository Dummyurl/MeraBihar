...
//    mRetry.setText(mInterface.labelRetry());
        ...
        mAddToStory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                mInterface.addToStory(mOutputUri);

                System.out.println("Output Uri = "+mOutputUri);
                Toast.makeText(getActivity(), "Output Uri "+mOutputUri, Toast.LENGTH_SHORT).show();
            }
        });
