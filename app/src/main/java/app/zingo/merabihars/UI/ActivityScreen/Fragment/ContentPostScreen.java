...
/**
 * A simple {@link Fragment} subclass.//fragment_content_post_screen
 */
public class ContentPostScreen extends Fragment {
    ...
    private int mStartType = RESULT_START_CAMERA;

    public ContentPostScreen() {
        // Required empty public constructor
    }

    public static ContentPostScreen newInstance() {
        ContentPostScreen fragment = new ContentPostScreen();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try{
            View view = inflater.inflate(R.layout.fragment_content_post_screen, container, false);
